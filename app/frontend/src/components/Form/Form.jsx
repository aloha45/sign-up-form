...
const validationSchema = Yup.object().shape({
	...
	data_sci_skillset: Yup.mixed().oneOf(
		Fields.dataSciSkills.choices,
		"Please choose from one of the selections"
	),
	bootcamp: Yup.mixed().oneOf(
		Fields.bootcamps.choices,
		"Please choose from one of the selections"
	),
